"""
Class to load ECG signal as MATLAB files from disk. Signals are segmented for given segment length 
and stored with corresponding labels in dataframe. For training of WGAN and DCGAN, only the first 
label was used, thus only first label was one hot encoded as a tensor. 
"""
