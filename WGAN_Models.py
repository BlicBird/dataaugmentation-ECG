"""
Discriminator and Generator sub-models for WGAN-GP
"""
...
class Discriminator(nn.Module):
    def __init__(self, channels_ecg, features_d, num_classes, ecg_length, embed_channels):
        ...
        self.disc = nn.Sequential(
            ...
            nn.Conv1d(
                channels_ecg + embed_channels, features_d, kernel_size=4, stride=2, padding=1
            ),
            nn.LeakyReLU(0.2),
...
class Generator(nn.Module):
    def __init__(self, channels_noise, channels_img, features_g, num_classes, noise_dim, embed_channels):
        ...
        self.net = nn.Sequential(
            ...
            self._block(channels_noise + embed_channels, features_g * 16, 4, 1, 1),  
